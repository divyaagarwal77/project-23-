...
function setup() {
	...
	boxSide1= createSprite(width/2,670,200,20,{isStatic:true});
	boxSide1.shapeColor=color("red")

	boxSide2=createSprite(290,630,20,100,{isStatic:true});
	boxSide2.shapeColor=color("red")

	boxSide3=createSprite(510,630,20,100,{isStatic:true});
